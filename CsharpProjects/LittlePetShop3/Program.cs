...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            bool validSearchTerms = false;

            while (validSearchTerms == false)
            {
                ...
                if (readResult != null)
                {
                    ...
                    dogSearchTerms = readResult.Split(',');
                    for (int i = 0; i < dogSearchTerms.Length; i++)
                    {
                        dogSearchTerms[i] = dogSearchTerms[i].Trim();
                    }
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    foreach (string searchTerm in dogSearchTerms)
                    {
                        ...
                        for (int j = 2; j > -1; j--)
                        {
                            ...
                            {
                                // \r will write over what is currently in the console, allowing for this animation to happen.
                                Console.Write($"\rSearching our dog {ourAnimals[i, 3]} for {searchTerm} {icon} {j}");
                                Thread.Sleep(250);
                            }
                        ...
                        if (dogDescription.Contains(searchTerm))
                        {
                            ...
                            Console.WriteLine($"\nOur dog {ourAnimals[i, 3]} is a match for your search for {searchTerm}!");
                    ...
                    if (!noTermMatch)
                    {
                        System.Console.WriteLine($"{ourAnimals[i,3]} ({ourAnimals[i,0]})\n{dogDescription}");
                    }
